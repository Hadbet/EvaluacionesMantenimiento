                        ...
                        <div class="col-xl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="basic-default-company">¿Conoce e identifica
                                                la estructura de los documentos que deberá utilizar para
                                                desempeñar sus tareas de Mantenimiento Autónomo?</label>
                                            <div class="form-check mt-3">
                                                <input name="txtPreguntaSiete" class="form-check-input" type="radio" value="OK"/>
                                                <label class="form-check-label" for="defaultRadio1"> OK </label>
                                            </div>
                                            <div class="form-check">
                                                <input name="txtPreguntaSiete" class="form-check-input" type="radio" value="NO OK"/>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check mt-3">
                                                <input name="txtPreguntaOcho" class="form-check-input" type="radio" value="OK"/>
                                                <label class="form-check-label" for="defaultRadio1"> OK </label>
                                            </div>
                                            <div class="form-check">
                                                <input name="txtPreguntaOcho" class="form-check-input" type="radio" value="NO OK"/>
                                                <label class="form-check-label" for="defaultRadio2"> NO OK </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="basic-default-company">¿Conoce el EPP que
                                                requiere para desarrollar sus actividades de MA y la manera de
                                                reportar en caso de identificar una condición insegura?</label>
                                            <div class="form-check mt-3">
                                                <input name="txtPreguntaNueve" class="form-check-input" type="radio" value="OK"/>
                                                <label class="form-check-label" for="defaultRadio1"> OK </label>
                                            </div>
                                            <div class="form-check">
                                                <input name="txtPreguntaNueve" class="form-check-input" type="radio" value="NO OK"/>
                                                <label class="form-check-label" for="defaultRadio2"> NO OK </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="basic-default-company">Al ejecutar las
                                                actividades descritas en las instruccines de trabajo de
                                                Mantenimiento Autónomo, no presenta dificultades e interpreta las
                                                instrucciones de
                                                manera correcta.</label>
                                            <div class="form-check mt-3">
                                                <input name="txtPreguntaDiez" class="form-check-input" type="radio" id="defaultRadio1" value="OK"/>
                                                <label class="form-check-label" for="defaultRadio1"> OK </label>
                                            </div>
                                            <div class="form-check">
                                                <input name="txtPreguntaDiez" class="form-check-input" type="radio" value="NO OK"/>
                                                <label class="form-check-label" for="defaultRadio2"> NO OK </label>
                                            </div>
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label" for="basic-default-company">¿En un supuesto de
                                                avería realiza el registro de manera correcta siguiendo el flujo
                                                de proceso? <span style="color: #0f33ff">Falla>> Team leader/Shift leader>>Registro en Check list de MA>>Orden de Trabajo (Mantenimiento)</span></label>
                                            <div class="form-check mt-3">
                                                <input name="txtPreguntaOnce" class="form-check-input" type="radio" value="OK"/>
                                                <label class="form-check-label" for="defaultRadio1"> OK </label>
                                            </div>
                                            <div class="form-check">
                                                <input name="txtPreguntaOnce" class="form-check-input" type="radio" value="NO OK"/>
                                                <label class="form-check-label" for="defaultRadio2"> NO OK </label>
                                            </div>
                                        </div>
